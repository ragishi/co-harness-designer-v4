...
| `05_operating_modes.md` | 新規作成 / 既存診断 / 既存改修 / CompanyOS 接続追加 / V4 改善の作業モード |
...
7. `05_operating_modes.md`

## 5. 最低 acceptance

- 6 つの判断ファイル（00–05）が揃っている（`09_v3_to_v4_mapping.md` は V3 対応表で別枠）
- 5 つの operation mode（作業モード）が定義されている（`05_operating_modes.md`）
