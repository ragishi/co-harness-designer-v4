...
- workflow archetype（`workflows/`）— planned stub として住所確保済み（`workflows/README.md` + 6 workflow 型）。本格運用は後段
...
| `10_common_core.md` | 全 archetype が持つ共通要素 | ✓ |
| `20_optional_modules.md` | 目的別に追加する module | ✓ |
...
3. `10_common_core.md`（全 archetype 共通の骨格 9 entries）
4. `20_optional_modules.md`（目的別に足す Optional Modules 8 種）
5. `repo/README.md`
6. `repo/note_production_repo.md`
7. `repo/client_repo.md`

## 5. 最低 acceptance

- archetype とは何かが framework で読める
- `10_common_core.md` が active で、Common Core 9 entries を説明している
- `20_optional_modules.md` が active で、Optional Modules 8 種を説明している
